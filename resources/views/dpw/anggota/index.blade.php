...
<div class="container">
    <div class="row">
        <div class="col-12">
            <br />
            <a href="/dpw/anggota/create" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i>
                Anggota</a><br /><br />
            <div class="card">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/dpw/anggota/edit/{{$item->id}}" class="btn btn-xs btn-success text-bold">
                                        EDIT
                                    </a>
                                    <a href="/dpw/anggota/delete/{{$item->id}}" class="btn btn-xs btn-danger text-bold"
