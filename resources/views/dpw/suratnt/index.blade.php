...
<div class="container">
    <div class="row">
        <div class="col-12">
            <br />
            <a href="/dpw/surat-nt/create" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> Surat
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/dpw/surat-nt/edit/{{$item->id}}" class="btn btn-xs btn-success text-bold">
                                        EDIT
                                    </a>
                                    <a href="/dpw/surat-nt/delete/{{$item->id}}" class="btn btn-xs btn-danger text-bold"
