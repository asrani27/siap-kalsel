...
<div class="container">
    <div class="row">
        <div class="col-12">
            <br />
            <a href="/dpw/rfk/create" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> Buat
                Laporan</a><br /><br />
            <div class="card">
                    ...
                    <table class="table table-hover table-bordered table-sm text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/dpw/rfk/detail/{{$item->id}}" class="btn btn-xs btn-primary text-bold">
                                        DETAIL
                                        RFK</a>
                                    <a href="/dpw/rfk/edit/{{$item->id}}" class="btn btn-xs btn-success text-bold"> EDIT
                                    </a>
                                    <a href="/dpw/rfk/delete/{{$item->id}}" class="btn btn-xs btn-danger text-bold"
