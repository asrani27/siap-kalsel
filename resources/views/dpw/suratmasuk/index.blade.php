...
<div class="container">
    <div class="row">
        <div class="col-12">
            <br />
            <a href="/dpw/surat-masuk/create" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> Surat
                Masuk</a><br /><br />
            <div class="card">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/dpw/surat-masuk/edit/{{$item->id}}"
                                        class="btn btn-xs btn-success text-bold"> EDIT
                                    </a>
                                    <a href="/dpw/surat-masuk/delete/{{$item->id}}"
