                ...
                <table class="table table-sm" style="border: 1px solid black; text-align:center">
                    <thead>
                        ...
                        <tr style="font-size:12px; background-color:rgb(211, 247, 236)">
                            <form id="edit-form" method="post" action="/dpd/rfk/detail/{{$id}}/okk/edit/{{$item->id}}">
                                @csrf
                                <td>
                                ...
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <textarea name="kode_akun" cols="30" rows="5">{{$item->kode_akun}}</textarea>
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <textarea name="program" cols="50" rows="5">{{$item->program}}</textarea>
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
