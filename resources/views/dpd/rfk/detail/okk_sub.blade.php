        ...
        <div class="card">
            ...
            <div class="card-body table-responsive">
                <table style="font-weight: bold;font-size:14px">
                    ...
                    <tr>
                        <td>BIDANG</td>
                        <td>: ORGANISASI DAN KADERISASI</td>
                    </tr>
                    <tr>
                ...
                <table class="table table-sm" style="border: 1px solid black; text-align:center">
                    <thead>
                        ...
                        @foreach ($data->okk as $key=> $item)
                        @if ($item->id == $okk_id)
                        <tr style="font-size:12px; background-color:rgb(235, 235, 232)">

                            <td style="display:flex;">
                                <a href="/dpd/rfk/detail/{{$id}}/okk/edit/{{$item->id}}"> <i class="fa fa-edit"></i>
                                </a>
                                &nbsp;&nbsp;&nbsp;
                                <a href="/dpd/rfk/detail/{{$id}}/okk/delete/{{$item->id}}"
                            ...
                            <td style="border: 1px solid black" class="text-bold text-left">{{$item->kode_akun}}
                                ...
                                <a href="/dpd/rfk/detail/{{$id}}/okk/sub/{{$item->id}}"><i
                            ...
                            <td style="border: 1px solid black" class="text-bold text-center">
                                {{ number_format($item->total_tertimbang_rr) }}
                            </td>
                            <td style="border: 1px solid black" class="text-bold text-right">
                        ...
                        <tr style="font-size:12px; background-color:rgb(255, 255, 251)">
                            ...
                            <td style="display:flex;">
                                <a
                                    href="/dpd/rfk/detail/{{$id}}/okk/sub/{{$subitem->rfkokk->id}}/edit/{{$subitem->id}}">
                                    <i class="fa fa-edit"></i>
                                </a>
                                &nbsp;&nbsp;&nbsp;
                                <a href="/dpd/rfk/detail/{{$id}}/okk/sub/{{$subitem->rfkokk->id}}/delete/{{$subitem->id}}"
                                    onclick="return confirm('Yakin ingin dihapus?');" class="text-red">
                                    <i class="fa fa-trash"></i>
                                </a>
                            </td>
                            ...
                            <td style="border: 1px solid black" class="text-center">
                                {{ number_format($subitem->tertimbang_rr) }}
                            </td>
                        ...
                        <tr style="font-size:12px; background-color:rgb(211, 247, 236)">
                            <form id="edit-form" method="post" action="/dpd/rfk/detail/{{$id}}/okk/sub/{{$item->id}}">
                                @csrf
                                <td style="display:flex;">
                                ...
                                <td style="border: 1px solid black"></td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <textarea name="kode_akun" cols="30" rows="5"></textarea>
                                    <button type="submit" class="btn btn-xs btn-primary"> SIMPAN
                                    </button>
                                    <a href="/dpd/rfk/detail/{{$id}}/okk" class="btn btn-xs btn-danger"> BATAL
                                    </a>
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <textarea name="program" cols="50" rows="5"></textarea>
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <textarea name="indikator" rows="5"></textarea>
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <textarea name="kegiatan" rows="5"></textarea>
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <textarea name="penanggung_jawab" rows="5"></textarea>
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <textarea name="tanggal_pelaksanaan" rows="5"></textarea>
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <input type="text" name="volume" value="" onkeypress="return hanyaAngka(event)" />
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                ...
                                <td style="border: 1px solid black" class="text-bold text-left"></td>
                                <td style="border: 1px solid black" class="text-bold text-left"></td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <input type="text" name="volume_rr" value=""
                                        onkeypress="return hanyaAngka(event)" />
                                </td>
                                ...
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <input type="text" name="jan" onkeypress="return hanyaAngka(event)" />
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <input type="text" name="feb" onkeypress="return hanyaAngka(event)" />
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <input type="text" name="mar" onkeypress="return hanyaAngka(event)" />
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <input type="text" name="apr" onkeypress="return hanyaAngka(event)" />
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <input type="text" name="mei" onkeypress="return hanyaAngka(event)" />
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <input type="text" name="jun" onkeypress="return hanyaAngka(event)" />
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <input type="text" name="jul" onkeypress="return hanyaAngka(event)" />
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <input type="text" name="augt" onkeypress="return hanyaAngka(event)" />
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <input type="text" name="sept" onkeypress="return hanyaAngka(event)" />
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <input type="text" name="okt" onkeypress="return hanyaAngka(event)" />
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <input type="text" name="nov" onkeypress="return hanyaAngka(event)" />
                                </td>
                                <td style="border: 1px solid black" class="text-bold text-left">
                                    <input type="text" name="des" onkeypress="return hanyaAngka(event)" />
                                </td>
                            </form>
                            <td style="border: 1px solid black" class="text-bold text-left"></td>
                            <td style="border: 1px solid black" class="text-bold text-left"></td>
