...
<div class="container">
    <div class="row">
        <div class="col-12">
            <br />
            <a href="/dpd/anggota/create" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i>
                Anggota</a><br /><br />
            <div class="card">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/dpd/anggota/edit/{{$item->id}}" class="btn btn-xs btn-success text-bold">
                                        EDIT
                                    </a>
                                    <a href="/dpd/anggota/delete/{{$item->id}}" class="btn btn-xs btn-danger text-bold"
