...
<div class="container">
    <div class="row">
        <div class="col-12">
            <br />
            <a href="/dpd/surat-masuk/create" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> Surat
                Masuk</a><br /><br />
            <div class="card">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/dpd/surat-masuk/edit/{{$item->id}}"
                                        class="btn btn-xs btn-success text-bold"> EDIT
                                    </a>
                                    <a href="/dpd/surat-masuk/delete/{{$item->id}}"
