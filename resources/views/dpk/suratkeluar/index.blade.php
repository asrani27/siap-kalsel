...
<div class="container">
    <div class="row">
        <div class="col-12">
            <br />
            <a href="/dpk/surat-keluar/create" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> Surat
                keluar</a><br /><br />
            <div class="card">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/dpk/surat-keluar/edit/{{$item->id}}"
                                        class="btn btn-xs btn-success text-bold"> EDIT
                                    </a>
                                    <a href="/dpk/surat-keluar/delete/{{$item->id}}"
