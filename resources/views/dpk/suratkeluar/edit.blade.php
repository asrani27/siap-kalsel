...
<div class="container">
    <div class="row">
        <div class="col-12">
            <br />
            <a href="/dpk/surat-keluar" class="btn btn-sm btn-primary"><i class="fa fa-arrow-left"></i>
                Kembali
            </a><br /><br />
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form method="post" action="/dpk/surat-keluar/edit/{{$data->id}}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="tindak_lanjut" value="{{$data->tindak_lanjut}}">
                        </div>
