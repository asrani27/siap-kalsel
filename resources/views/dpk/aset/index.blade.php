...
<div class="container">
    <div class="row">
        <div class="col-12">
            <br />
            <a href="/dpk/aset/create" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i>
                aset</a><br /><br />
            <div class="card">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/dpk/aset/edit/{{$item->id}}" class="btn btn-xs btn-success text-bold">
                                        EDIT
                                    </a>
                                    <a href="/dpk/aset/delete/{{$item->id}}" class="btn btn-xs btn-danger text-bold"
