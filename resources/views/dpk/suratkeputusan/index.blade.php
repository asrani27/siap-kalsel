...
<div class="container">
    <div class="row">
        <div class="col-12">
            <br />
            <a href="/dpk/surat-keputusan/create" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> Surat
                keputusan</a><br /><br />
            <div class="card">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/dpk/surat-keputusan/edit/{{$item->id}}"
                                        class="btn btn-xs btn-success text-bold"> EDIT
                                    </a>
                                    <a href="/dpk/surat-keputusan/delete/{{$item->id}}"
