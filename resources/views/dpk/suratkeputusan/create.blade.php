...
<div class="container">
    <div class="row">
        <div class="col-12">
            <br />
            <a href="/dpk/surat-keputusan" class="btn btn-sm btn-primary"><i class="fa fa-arrow-left"></i>
                Kembali
            </a><br /><br />
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form method="post" action="/dpk/surat-keputusan/create">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="nama_bidang" required>
                                ...
                                <option value="{{$item->nama}}" {{Auth::user()->dpk->bidang == $item->nama ?
