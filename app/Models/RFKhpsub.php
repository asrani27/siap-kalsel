...
class RFKhpsub extends Model
{
    protected $table = 'rfk_hp_sub';
    protected $guarded = ['id'];
    public function rfkhp()
    {
        return $this->belongsTo(RFKhp::class, 'rfk_hp_id');
    }
    ...
    {
        $totalJumlahAnggaran = $this->rfkhp->total_jumlah_anggaran;
