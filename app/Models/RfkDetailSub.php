...
class RfkDetailSub extends Model
{
    protected $table = 'rfk_detail_sub';
    protected $guarded = ['id'];
    public function rfkdetail()
    {
        return $this->belongsTo(RfkDetail::class, 'rfk_detail_id');
    }
    ...
    {
        $totalJumlahAnggaran = $this->rfkdetail->total_jumlah_anggaran;
